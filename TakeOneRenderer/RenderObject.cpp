...
TakeOne::RenderObject::RenderObject(const Material::MaterialFormat& pMaterialFormat, const char* pModelName)
	: mMesh(new Mesh)
...
TakeOne::RenderObject::RenderObject(const std::string & pResource_key, void * pArgs)
	: mMesh(new Mesh)
	, mMaterial(new Material())
...
bool TakeOne::RenderObject::LoadModel(const char* pFilename)
{
...
bool TakeOne::RenderObject::LoadMaterial(const Material::MaterialFormat& pMaterialFormat)
{
...
bool TakeOne::RenderObject::Load(const Material::MaterialFormat& pMaterialFormat, const char* pModelName)
{
